...
import { TerminalWorkspaceSyncContribution } from './terminalWorkspaceSync.js';
...
registerWorkbenchContribution2(TerminalWorkspaceSyncContribution.ID, TerminalWorkspaceSyncContribution, WorkbenchPhase.AfterRestored);
